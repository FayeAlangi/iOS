...
class SceneDelegate: UIResponder, UIWindowSceneDelegate {
    ...
    private enum Constants {
        ...
        static let homePageNavigationControllerIdentifier = "HomePageNavigationController"
        static let homePageTabBarControllerIdentifier = "HomePageTabBarController"
    ...
    private func login() {
      ...
      self.window?.rootViewController = storyboard.instantiateViewController(withIdentifier: Constants.homePageTabBarControllerIdentifier)
    }
